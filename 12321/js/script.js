document.addEventListener('DOMContentLoaded', () => {
    // const ll = document.querySelector('meta[name="theme-color"]');
    const ll = document.getElementsByName("theme-color");
    console.log(ll[0].content);
    ll[0].setAttribute("content", "#000000")
    // 2 setAttribut 1 для афйфона, другой для всего остального, закинуть их к прокртке и свайпам и кликам в условия
    console.log(ll[0].content);
    ...
    function changePagesOnMobile() { 
        ...
        //safe mechanism against when swiping cards
