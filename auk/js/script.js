document.addEventListener('DOMContentLoaded', () => {
    ...
    function drawCircle(rotation = 0, r = 0, g = 0, b = 0) {
      ...
      for (let piePart of lots) {
        ...
        cx.beginPath();
        cx.arc(xMiddle, yMiddle, radius, (prevAngle + currentAngle + rotation) * 2 * Math.PI, (prevAngle + currentAngle + sliceAngle + rotation) * 2 * Math.PI);
        ...
        cx.fillStyle = "#000";
        cx.rotate((currentAngle + sliceAngle / 2 + rotation + prevAngle) * 2 * Math.PI);
        cx.textAlign = "left";
    ...
    function rolling() {
      ...
      const timerId = setInterval(()=> {
        ...
        let r = cx.getImageData(xMiddle - 1, yMiddle - radius + 10, 1, 1).data[0];
        let g = cx.getImageData(xMiddle - 1, yMiddle - radius + 10, 1, 1).data[1];
        let b = cx.getImageData(xMiddle - 1, yMiddle - radius + 10, 1, 1).data[2];
