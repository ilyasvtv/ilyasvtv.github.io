document.addEventListener('DOMContentLoaded', () => {
    ...
    let offsetX = 0;
    let offsetValueX = Math.round(window.innerWidth * 0.18);
    let offsetY = Math.round(window.innerHeight * 0.3);
    letters.forEach(e => {
    ...
    //apearing of logo and hamburger
